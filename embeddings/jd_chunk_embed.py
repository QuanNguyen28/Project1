...
from embeddings.chunk_utils import (
    embed_chunks,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Index JD content for dense and hybrid retrieval"
    )

    parser.add_argument("--only", type=int, help="Reindex only this jd_id")

    parser.add_argument(
        "--no-save", action="store_true", help="Do not write local chunk files"
    )
