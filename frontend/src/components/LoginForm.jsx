...
export default function LoginForm({ onSubmit: onSubmitProp, error: externalError = '' }) {
  const { login } = useAuth()
      ...
      <NeumorphicCard className="p-8">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            ...
            <input className="input" value={username} onChange={e=>setUsername(e.target.value)} placeholder="hr_admin" />
          </div>
          <div>
