...
GEMINI_LLM_RETRY_BASE_SECONDS = float(os.getenv("GEMINI_LLM_RETRY_BASE_SECONDS", "1.25"))
...
# Browser origins allowed to call the API. Never combine wildcard origins with
# credentialed requests in production.
CORS_ORIGINS = [
    item.strip()
